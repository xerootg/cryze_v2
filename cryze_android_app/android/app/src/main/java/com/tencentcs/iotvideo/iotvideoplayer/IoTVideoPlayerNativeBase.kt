...
abstract class IoTVideoPlayerNativeBase(TAG: String) : IIoTVideoPlayer {
    ...
    init {
        ...
        LogUtils.i(
            TAG, "java player created, nativeObject: "
    ...
    external fun nativeMute(isMuted: Boolean)
    ...
    external fun nativeSetDataResource(
        deviceId: String?,
        callType: Int,
    ...
    external fun nativeUpdateAccessIdAndToken(accessId: Long, token: String?)

    // to be implemented by the subclass to release the stuff it made
