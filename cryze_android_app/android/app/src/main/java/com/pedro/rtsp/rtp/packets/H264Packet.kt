...
class H264Packet(
    ...
    override fun createAndSendPacket(
        ...
        if (sendKeyFrame) {
            ...
            if (currentTime - lastLogTime >= logBackoffDuration.inWholeMilliseconds) {
                Log.d(TAG, "waiting for keyframe")
                lastLogTime = currentTime
            }
        }
    }

    // backoff for keyframe logger
    private var lastLogTime: Long = 0
    private val logBackoffDuration = 5.seconds // Set the backoff duration
